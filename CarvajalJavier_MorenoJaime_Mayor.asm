...
main:
    ...
    li $t4, -2147483648       # valor mínimo posible para mayor (min int)
...
input_loop:
    ...
    blt $t5, $t4, skip        # si $t5 < $t4, no hacer nada
...
end_input:
    ...
    li $v0, 4                 # syscall para imprimir string
    la $a0, msg_mayor         # cargar dirección del mensaje
    syscall

    li $v0, 1                 # syscall para imprimir un entero
    move $a0, $t4             # número mayor en $t4
    syscall
